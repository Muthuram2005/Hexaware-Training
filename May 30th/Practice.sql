use retail_db;
create table customers (customer_id int primary key, customer_name varchar(50), city varchar(50), phone varchar(15));
create table orders (order_id int primary key, customer_id int, product_name varchar(50), order_amount decimal(10,2), order_status varchar(30));
